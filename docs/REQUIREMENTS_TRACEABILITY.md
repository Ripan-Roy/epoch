...
| QUEUE-004 | P0 | Delayed and scheduled messages | M1 prototype → M2 | Slice | G0, G2, G4 | Deterministic tablet monotonic/TTL/max-age tests plus real container scheduled ineligibility/promotion and explicit committed maintenance; pending: automatic timer proposal and precision load report |
