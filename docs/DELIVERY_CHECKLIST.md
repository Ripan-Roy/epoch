...
**Current core target:** Regional Cache v1 and complete three-language SDK lifecycle
...
| G4 | Native profile cores | 🟡 | Cache, Stream, Queue, and Bus P0 semantics with truthful public routing and fault evidence | All four typed tablet cores run simultaneously behind resource/shard routing and pass process/container recovery; Stream, Queue, and Cache have authenticated versioned three-language clients, while Event Bus public routing and remaining P0 breadth are open |
...
| RC-07 | Publish executable end-to-end docs | Docs + Pages | 🟡 | Regional Cache guide, ADR, cross-cutting docs, exact Go/Java/Python programs, docs compile gate, navigation, and Pages content assertions are included in this feature branch |
| RC-08 | Pass protected pull-request evidence | GitHub | ⬜ | Full local gates, PR CI, and Pages verification must pass before merge; deployment remains restricted to `main` |
